package org.arcticquests.dev.world.entity.ai.goal;
...
//Like this is a duplicate class MeleeaGoal in mc (idk why original author coded leaving it j.i.c)

public class TimedMeleeAttackGoal extends Goal{
    ...
    public TimedMeleeAttackGoal(PathAwareEntity mob, double speed, boolean pauseWhenMobIdle) {
        this.mob = mob;
        this.speed = speed;
